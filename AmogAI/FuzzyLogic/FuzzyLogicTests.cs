...
namespace Tests
{
    public class FuzzyLogicTests
    {
        ...
        public void Desirability200Distance8AmmoWithAllRules()
        {
            ...
            Assert.AreEqual(0.20, Math.Round(desirableDom, 2));
            Assert.AreEqual(0.33, Math.Round(undesirableDom, 2));
            Assert.AreEqual(0.67, Math.Round(veryDesirableDom, 2));
        }
        ...
        public void Desirability200Distance8AmmoWithAllTargetCloseRules()
        {
            ...
            Assert.AreEqual(0, Math.Round(desirableDom, 2));
            Assert.AreEqual(0, Math.Round(undesirableDom, 2));
            Assert.AreEqual(0, Math.Round(veryDesirableDom, 2));
        }
